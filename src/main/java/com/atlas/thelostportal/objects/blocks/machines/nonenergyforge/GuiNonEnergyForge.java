...
public class GuiNonEnergyForge extends GuiContainer
{
	...
	public GuiNonEnergyForge(InventoryPlayer player, TileEntityNonEnergyForge tileEntityBasicFurnace) 
	{
		super(new ContainerNonEnergyForge(player, tileEntityBasicFurnace));
		this.player = player;
		this.tileentity = tileEntityBasicFurnace;
	}
